...
async function migrate() {
  console.log('Starting Migration from MongoDB to Neon PostgreSQL...');
  ...
  try {
    ...
    console.log('Migrating About & Nested arrays...');
    ...
    console.log('Migrating Additional Technologies...');
    ...
    console.log('Migrating Contacts, Social Links & Settings...');
    ...
    for (const s of settings) {
       await prisma.settings.create({
          data: {
             ...
             customJS: s.customJS || "",
             footerText: s.footerText || "© 2025 Zain L. Alhamoud. All rights reserved.",
             createdAt: s.createdAt || new Date(),
             updatedAt: s.updatedAt || new Date()
          }
       });
